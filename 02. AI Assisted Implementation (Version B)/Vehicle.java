 ...
 * Holds the attributes shared by every vehicle type (Car, Van, Motorcycle):
 * an identifier, a display name, the daily rental rate and whether the
 * vehicle is currently available to rent.
 */
